class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:user_id, :sourceaddress, :servicehour, :targetaddress, :rate_id, :servicedate, :passengernumber, :vehicle_id, :paymenttype, :registrationdate, :registrationhour, :rating, :commentservice, :status)
    end
end
