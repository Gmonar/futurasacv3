...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { district_end: @rate.district_end, district_start: @rate.district_start, price: @rate.price, status: @rate.status }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { district_end: @rate.district_end, district_start: @rate.district_start, price: @rate.price, status: @rate.status }
    assert_redirected_to rate_path(assigns(:rate))
  end
